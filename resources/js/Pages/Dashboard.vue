        ...
        <div class="grid grid-cols-3 w-full py-10">
            <div class="flex">
                <div class="mx-auto rounded bg-[#32384D] p-3">
                    <svg width="23" height="24" viewBox="0 0 23 24" fill="none" class="mx-auto" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex">
                <div class="mx-auto rounded bg-[#32384D] p-3">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" class="mx-auto" xmlns="http://www.w3.org/2000/svg">
