        ...
        <div class="flex">
            <div class="flex mx-auto">
                <div class="flex items-center gap-2">
                    ...
                    <div class="text-white text-lg">$ 5454<span class="text-[#656D85]">.12</span></div>
                </div>
                <div class="flex items-center ml-4 gap-2">
                    ...
                    <div class="text-white text-lg">$ 2346<span class="text-[#656D85]">.12</span></div>
                </div>
            </div>
        </div>
        <div class="flex w-full mt-4">
            <div class="text-white flex mx-auto">
                <div class="items-center gap-2 flex px-8 bg-[#0095FF] py-4 rounded-l-full">
                ...
                <div class="items-center gap-2 flex px-8 bg-[#8972FF] py-4 rounded-r-full">
